...
SRC_URI="https://github.com/werman/noise-suppression-for-voice/releases/download/v${PV}/linux_rnnoise_bin_x64.tar.gz"
...
src_install() {
	insinto "/opt/${PN}/"
	doins "${WORKDIR}/bin/ladspa/librnnoise_ladspa.so"
